...
using ThemeTestingProjectDemo.MultiTenancy;

namespace ThemeTestingProjectDemo.Web.Startup
{
    [DependsOn(
        typeof(ThemeTestingProjectDemoWebCoreModule)
    )]
    public class ThemeTestingProjectDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ThemeTestingProjectDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ThemeTestingProjectDemoWebHostModule).GetAssembly());
        }
